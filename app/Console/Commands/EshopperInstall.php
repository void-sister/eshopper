...
class EshopperInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'eshopper:install {--force : Do not ask for user confirmation.}';
     ...
     * @var string
     */
    protected $description = 'Install dummy data for Eshopper App';
