					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{ URL::asset('images/products/' . $product->slug . '_xl.jpg') }}" alt="{{ $product->name }}" />
								<h3>ZOOM</h3>
							</div>
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
											<div class="item active">
												@for ($i = 1; $i <= 3; $i++)
														<a href="#"><img src="{{ URL::asset('images/products/' . $product->slug . '_xl_' . $i . '.jpg') }}" alt="{{ $product->name }}" height="100" width="70" /></a>
												@endfor
											</div>
										</div>
							</div>
